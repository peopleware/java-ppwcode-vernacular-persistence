 ...
 * which roles are allowed to create beans of that type.
 *
 * @author    Jan Dockx
 */
...
public @interface CreateAllowedBy {

  /**
   * Array of role names allowed to create the annotated {@link VersionedPersistentBean}.
   */
  String[] value();
