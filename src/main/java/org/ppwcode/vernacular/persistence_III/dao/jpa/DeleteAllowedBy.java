 ...
 * which roles are allowed to delete beans of that type.
 *
 * @author    Jan Dockx
 */
...
public @interface DeleteAllowedBy {

  /**
   * Array of role names allowed to delete the annotated {@link VersionedPersistentBean}.
   */
  String[] value();
