/*<license>
Copyright 2004 - $Date: 2008-06-27 12:13:23 +0200 (Fri, 27 Jun 2008) $ by PeopleWare n.v..
...
package org.ppwcode.vernacular.persistence_III.junit.hibernate3;
 ...
 */
public abstract class AbstractHibernate3PersistentBeanTest<_Id_ extends Serializable, _PersistentBean_ extends PersistentBean<_Id_>> extends AbstractHibernate2Test {

  private static final Log LOG = LogFactory.getLog(AbstractHibernate3PersistentBeanTest.class);
  ...
  protected AbstractHibernate3PersistentBeanTest(final Class<_PersistentBean_> classUnderTest) {
